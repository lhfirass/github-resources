...
if ( $has_video_bg ) {
	...
	$column_background = '<video class="video-container" autoplay preload="auto" loop="loop" muted="muted" poster="'.EQUIPO_ENOVATHEMES_IMAGES.'/transparent.png">';
		if ($video_bg_mp4){
...
<div <?php echo implode( ' ', $wrapper_attributes ); ?> >
	<div class="vc_column-inner vci <?php echo esc_attr( trim( vc_shortcode_custom_css_class( $css ) ) )?>" <?php echo implode( ' ', $responsive_padding ); ?>>
		...
		<?php echo equipo_enovathemes_output_html($column_background); ?>
	</div>
</div>